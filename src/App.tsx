...
export default function App() {
  ...
  // Base visibility (hide out of stock if config enabled)
  const visibleProducts = shopConfig?.hideOutOfStock 
        ...
        <div id="app-navbar" className="md:hidden fixed bottom-[max(1.5rem,env(safe-area-inset-bottom))] left-1/2 -translate-x-1/2 z-40 w-[90%] max-w-[340px] pointer-events-none">
          ...
          >
            ...
            >
              ...
              <span className="text-[7px] font-bold uppercase tracking-[0.2em]">Guía</span>
            </button>
