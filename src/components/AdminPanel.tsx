    ...
    <div className="admin-container w-full max-w-[1600px] mx-auto py-4 sm:py-8 px-2 sm:px-6 animate-fade-in">
      ...
      {activeTab === "ventas" && (
        ...
        >
          ...
          {ventasView === "graficas" && (
            <Suspense fallback={<div className="p-8 text-center text-slate-400 font-bold text-xs uppercase tracking-wider">Cargando Gráficas de Rendimiento...</div>}>
              <SalesCharts
                sales={sales}
                products={products}
      ...
      {activeTab === "estadisticas" && (
        ...
        >
          ...
          {estadisticasView === "cloud" && (
            <Suspense fallback={<div className="p-8 text-center text-slate-400 font-bold text-xs uppercase tracking-wider">Cargando Estadísticas Cloud...</div>}>
          ...
          {estadisticasView === "graficas" && (
            <div className="space-y-12">
              ...
              <Suspense fallback={<div className="p-8 text-center text-slate-400 font-bold text-xs uppercase tracking-wider">Cargando Gráficas de Ventas...</div>}>
      ...
      {activeTab === "ajustes" && (
        <Suspense fallback={<div className="p-8 text-center text-slate-400 font-bold text-xs uppercase tracking-wider">Cargando Ajustes...</div>}>
          <SettingsPanel
            shopConfig={shopConfig}
          ...
          onResetSales={() => {
            setConfirmModal({
              isOpen: true,
              title: "¿BORRAR VENTAS?",
              message: "Se eliminarán permanentemente todas las ventas de la base de datos.",
              onConfirm: async () => {
                try {
                  const activePass = sessionStorage.getItem("admin_password") || contrasenaAdmin || shopConfig.contrasenaAdmin || "PipeAdmin2026";
          ...
          onClearCache={() => {
            setConfirmModal({
              ...
              message: "¿Deseas borrar el almacenamiento local y recargar la aplicación?",
      ...
      {activeTab === "auditoria" && (
        <Suspense fallback={<div className="p-8 text-center text-slate-400 font-bold text-xs uppercase tracking-wider">Cargando Auditoría...</div>}>
          <AdminAuditoriaTab
            contrasenaAdmin={contrasenaAdmin}
      ...
      {isPreviewOpen && (
        <div className="fixed inset-0 z-[90] flex flex-col bg-slate-900/40 backdrop-blur-md p-4">
          ...
          <div className="flex-1 flex flex-col bg-white dark:bg-zinc-950 max-w-6xl w-full mx-auto md:rounded-2xl border border-slate-200 dark:border-zinc-800 shadow-2xl overflow-hidden transition-all">
            ...
            <Suspense fallback={<div className="p-8 text-center text-slate-400 font-bold text-xs uppercase tracking-wider">Cargando Vista Previa...</div>}>
