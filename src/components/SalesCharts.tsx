...
import { MonthlyFlavorsBarChart } from "./MonthlyFlavorsBarChart";
...
export const SalesCharts: React.FC<SalesChartsProps> = ({
  ...
  const approvedSales = useMemo(() => {
    let base = sales.filter((s) => s && s.estado !== "Eliminada" && s.estado !== "Rechazado");
        ...
        approvedSales.forEach((s) => {
          (s.items || []).forEach((item) => {
            ...
            flavorSalesCount[item.nombre] =
              (flavorSalesCount[item.nombre] || 0) + qty;
          });
        });
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Dedicated Bar Chart: Top Selling Flavors in the Last Month */}
      <MonthlyFlavorsBarChart sales={sales} products={products} />
